...
class Vector:
    ...
    def tuple__eq__(self, tupl: tuple):
        return self.x == tupl[0] and self.y == tupl[1] and len(tupl) == 2
    ...
    @__ne__.register(tuple)
    def tuple__ne__(self, tupl: tuple):
        return self.x != tupl[0] or self.y != tupl[1] or len(tupl) != 2
